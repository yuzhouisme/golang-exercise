...
func (uq *UserQuery) QueryOrders() *OrderQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, user.OrdersTable, user.OrdersPrimaryKey...),
		)
...
//
//	client.User.Query().
//		GroupBy(user.FieldBusinessName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
	...
	if query := uq.withOrders; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(user.OrdersPrimaryKey[0], fks...))
			},
